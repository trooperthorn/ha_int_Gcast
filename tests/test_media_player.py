...
from custom_components.cast import (
    CastRuntimeData,
...
from custom_components.cast.media_player import ChromecastInfo
...
async def async_setup_media_player_cast(hass: HomeAssistant, info: ChromecastInfo):
    ...
    with (
        patch(
            "custom_components.cast.discovery.pychromecast.get_chromecast_from_cast_info",
